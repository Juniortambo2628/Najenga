...
return [
    ...
    'image_generators' => [
        ...
        Webp::class,
        Avif::class,
        // Custom PDF generator — uses Ghostscript CLI when Imagick isn't installed.
        // Listed before the built-in Pdf so it's preferred on systems without Imagick.
        \App\Conversions\PdfFirstPageThumbnail::class,
        Pdf::class,
        Svg::class,
        Video::class,
    ],
