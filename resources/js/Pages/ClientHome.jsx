            ...
            <div>
                ...
                <div className="mb-12">
                    {recentPhotos.length > 0 ? (
                            ...
                            {recentPhotos.map((photo) => (
                                <SwiperSlide key={photo.id} className="w-[640px] h-[360px] rounded-2xl overflow-hidden relative group shadow-2xl border border-white/10 bg-black">
                                    ...
                                    <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/20 to-transparent opacity-0 group-hover:opacity-100 group-focus-within:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-6">
                                        ...
                                        <p className="text-gray-300 text-xs mb-1 flex items-center"><i aria-hidden="true" className="fas fa-map-marker-alt w-4 text-center mr-1"></i>{photo.project_location}</p>
                                        <p className="text-gray-400 text-[10px] flex items-center"><i aria-hidden="true" className="far fa-calendar w-4 text-center mr-1"></i>{photo.created_at_formatted}</p>
                                    </div>
                                </SwiperSlide>
                            ))}
                        </Swiper>
                        ...
                        <div className="text-center py-12 bg-gray-900/50 rounded-3xl border border-white/10 max-w-4xl mx-auto">
                            <i aria-hidden="true" className="fas fa-images text-6xl text-gray-400 mb-4"></i>
                ...
                <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
                    ...
                    <div className="bg-gray-900/50 border border-white/10 rounded-3xl p-8 text-center hover:border-white/30 transition shadow-2xl backdrop-blur-sm">
                        <i aria-hidden="true" className="fas fa-project-diagram text-5xl text-[#8B0000] mb-4"></i>
                        ...
                        >
                            <i aria-hidden="true" className="fas fa-tachometer-alt mr-2"></i>
                            Go to Dashboard
                        </Link>
                    </div>
                    ...
                    {/* Quick Upload Card */}
                    <div className="bg-gray-900/50 border border-white/10 rounded-3xl p-8 text-center hover:border-white/30 transition shadow-2xl backdrop-blur-sm">
                        <i aria-hidden="true" className="fas fa-bolt text-5xl text-yellow-400 mb-4"></i>
                        ...
                        <div className="flex flex-wrap justify-center gap-4">
                            <Link href="/receipt-verification" className="flex items-center gap-3 px-5 py-3 bg-white/5 border border-white/10 rounded-full hover:bg-white/10 hover:border-yellow-400/50 transition group">
                                <span className="w-8 h-8 rounded-full bg-yellow-400/20 flex items-center justify-center text-yellow-400 group-hover:scale-110 transition"><i aria-hidden="true" className="fas fa-receipt"></i></span>
                            ...
                            <button onClick={() => setUploadType('photo')} className="flex items-center gap-3 px-5 py-3 bg-white/5 border border-white/10 rounded-full hover:bg-white/10 hover:border-cyan-400/50 transition group">
                                <span className="w-8 h-8 rounded-full bg-cyan-400/20 flex items-center justify-center text-cyan-400 group-hover:scale-110 transition"><i aria-hidden="true" className="fas fa-camera"></i></span>
                            ...
                            <button onClick={() => setUploadType('document')} className="flex items-center gap-3 px-5 py-3 bg-white/5 border border-white/10 rounded-full hover:bg-white/10 hover:border-red-500/50 transition group">
                                <span className="w-8 h-8 rounded-full bg-red-500/20 flex items-center justify-center text-red-500 group-hover:scale-110 transition"><i aria-hidden="true" className="fas fa-file-pdf"></i></span>
