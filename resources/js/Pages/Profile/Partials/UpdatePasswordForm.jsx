    ...
    return (
        <section className={className}>
            ...
            <form onSubmit={updatePassword} className="space-y-6">
                <div>
                    <InputLabel htmlFor="current_password" value="Current Password" className="text-gray-400" />
                    <TextInput
                        id="current_password"
                ...
                <div>
                    <InputLabel htmlFor="password" value="New Password" className="text-gray-400" />
                    <TextInput
                        id="password"
                        ref={passwordInput}
                        value={data.password}
                ...
                <div>
                    <InputLabel htmlFor="password_confirmation" value="Confirm Password" className="text-gray-400" />
                    <TextInput
